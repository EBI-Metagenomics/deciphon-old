...
void test_std_profile(void)
{
    ...
    struct dcp_std_profile p0;
    dcp_std_profile_init(&p0, &m->abc);
    dcp_profile_nameit(dcp_super(&p0), mt0);
    ...
    struct dcp_std_profile p1;
    dcp_std_profile_init(&p1, &m->abc);
    dcp_profile_nameit(dcp_super(&p1), mt1);
