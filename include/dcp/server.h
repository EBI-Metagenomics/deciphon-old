...
DCP_API void                       dcp_server_add(struct dcp_server* server, struct dcp_task* task);
DCP_API struct dcp_server*         dcp_server_create(char const* filepath);
DCP_API void                       dcp_server_destroy(struct dcp_server* server);
DCP_API void                       dcp_server_join(struct dcp_server* server);
...
DCP_API void                       dcp_server_free_results(struct dcp_server* server, struct dcp_results* results);
