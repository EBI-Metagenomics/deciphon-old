...
DCP_API struct dcp_partition*   dcp_partition_create(char const* filepath, uint64_t start_offset,
                                                     uint32_t nmodels);
DCP_API struct nmm_model const* dcp_partition_read(struct dcp_partition* part);
