...
DCP_API char const*              dcp_result_alt_codon_stream(struct dcp_result const* result);
...
DCP_API char const*              dcp_result_null_stream(struct dcp_result const* result);
DCP_API char const*              dcp_result_null_codon_stream(struct dcp_result const* result);
