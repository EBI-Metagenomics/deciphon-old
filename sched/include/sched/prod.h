...
EXPORT enum rc sched_prod_get(struct sched_prod *prod);
EXPORT enum rc sched_prod_add(struct sched_prod *prod);
EXPORT enum rc sched_prod_add_file(FILE *fp);
...
EXPORT enum rc sched_prod_write_match_sep(unsigned file_num);
EXPORT enum rc sched_prod_write_end(unsigned file_num);
