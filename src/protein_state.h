...
{
    PROTEIN_MATCH_STATE = (0 << (DCP_BITS_PER_PROFILE_TYPEID - 2)),
    PROTEIN_INSERT_STATE = (1 << (DCP_BITS_PER_PROFILE_TYPEID - 2)),
    PROTEIN_DELETE_STATE = (2 << (DCP_BITS_PER_PROFILE_TYPEID - 2)),
    PROTEIN_EXT_STATE = (3 << (DCP_BITS_PER_PROFILE_TYPEID - 2)),
