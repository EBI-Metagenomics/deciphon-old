...
#define PROTEIN_ID_MATCH (0U << (DCP_BITS_PER_PROFILE_ID - 2))
#define PROTEIN_ID_INSERT (1U << (DCP_BITS_PER_PROFILE_ID - 2))
#define PROTEIN_ID_DELETE (2U << (DCP_BITS_PER_PROFILE_ID - 2))
#define PROTEIN_ID_EXT (3U << (DCP_BITS_PER_PROFILE_ID - 2))
