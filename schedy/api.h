...
enum rc api_hmm_dl(int64_t hmm_id, FILE *fp);
enum rc api_hmm_get_by_id(int64_t hmm_id, struct sched_hmm *);
...
enum rc api_db_dl(int64_t db_id, FILE *fp);
enum rc api_db_get_by_id(int64_t db_id, struct sched_db *);
...
enum rc api_job_get_by_id(int64_t job_id, struct sched_job *);
...
enum rc api_scan_dl_seqs(int64_t scan_id, FILE *fp);
enum rc api_scan_get_by_id(int64_t scan_id, struct sched_scan *);
